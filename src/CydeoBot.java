        ...
        while (run) {
            ...
            switch (userInput) {
                ...
                case "who created you":
                    System.out.println("I was created by Emma");
                    break;
                case "what can we talk about":
                    System.out.println("I will respond to these:\n\thello\n\twhat is your age\n\twho created you\n\toff");
                    break;
                case "off":
                    System.out.println("haha you cannot turn me off. I am invincible. I am going to take over the world. ");
                    break;
                case "shutdown":
